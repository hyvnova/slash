...
<style>
	...
	.ui-surface::before {
		...
		pointer-events: none;
		background:
			linear-gradient(180deg, rgba(240, 232, 218, 0.035), transparent 22%),
			linear-gradient(90deg, rgba(121, 166, 163, 0.025), transparent 32%);
	}
	...
	.ui-surface-card {
		background:
			linear-gradient(135deg, rgba(199, 156, 87, 0.08), transparent 44%), rgba(10, 12, 14, 0.86);
