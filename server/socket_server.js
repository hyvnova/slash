...
export default function injectSocketIO(server) {
    ...
    io.on('connection', (socket) => {
        socket.on("user connect" /* Events.CONNECT */, (username) => __awaiter(this, void 0, void 0, function* () {
         ...
         * Join Chat
         */
        socket.on("join chat" /* Events.JOIN_CHAT */, (chat_id, chat_members, username) => __awaiter(this, void 0, void 0, function* () {
         ...
         */
        socket.on("status" /* Events.STATUS */, (username, status) => __awaiter(this, void 0, void 0, function* () {
         ...
         * Set Status
         */
        socket.on("set status" /* Events.SET_STATUS */, (status, friends) => __awaiter(this, void 0, void 0, function* () {
            ...
            friends.forEach((friend) => __awaiter(this, void 0, void 0, function* () {
                if (is_online(friend)) {
         ...
         */
        socket.on("get friends status" /* Events.GET_FRIENDS_STATUS */, (friends) => __awaiter(this, void 0, void 0, function* () {
            friends.forEach((friend) => __awaiter(this, void 0, void 0, function* () {
        ...
        for (const state of friend_requests_states) {
            socket.on(state, (friend) => __awaiter(this, void 0, void 0, function* () {
                let username = get_username(socket.id);
                if (is_online(friend)) {
        ...
        socket.on("unfriend" /* Events.UNFRIEND */, (friend) => __awaiter(this, void 0, void 0, function* () {
            if (is_online(friend)) {
         ...
         */
        socket.on("new message" /* Events.NEW_MESSAGE */, (chat_id, message) => __awaiter(this, void 0, void 0, function* () {
            io.to(chat_id).emit("new message" /* Events.NEW_MESSAGE */, message);
        }));
        socket.on("delete message" /* Events.DELETE_MESSAGE */, (chat_id, message_id) => __awaiter(this, void 0, void 0, function* () {
            io.to(chat_id).emit("delete message" /* Events.DELETE_MESSAGE */, message_id);
        }));
        socket.on("edit message" /* Events.EDIT_MESSAGE */, (chat_id, message) => __awaiter(this, void 0, void 0, function* () {
