...
const css = {
  code: ".spin.svelte-chiuqu{-webkit-animation:svelte-chiuqu-spin 2s 0s infinite linear;animation:svelte-chiuqu-spin 2s 0s infinite linear}.pulse.svelte-chiuqu{-webkit-animation:svelte-chiuqu-spin 1s infinite steps(8);animation:svelte-chiuqu-spin 1s infinite steps(8)}@-webkit-keyframes svelte-chiuqu-spin{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}@keyframes svelte-chiuqu-spin{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg);transform:rotate(360deg)}}",
  map: null
};
const Fa = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${i[4] ? `<svg${add_attribute("id", id || void 0, 0)} class="${[
    "svelte-fa " + escape(clazz, true) + " svelte-chiuqu",
